...
const resultData = {
    ...
    PNBO: { title: "日体大卒総理大臣",               text: "周囲の状況を的確に把握し、ここぞという時に右ストレート！！一人でも空気をガラッと変えることができるポテンシャルを秘めている！" },
    ...
    PABO: { title: "力士カメレオン",                 text: "張り手、うっちゃり、がぶりより、あらゆる戦術すべてを使いこなすテクニシャン！！土俵の上で誰も敵なし！すべて君の独壇場！！" },
    ...
    SAIO: { title: "",                       text: "状況に合わせてすばやく仮面を変える君はまさに変面師！！起用にキャラを使い分けクリティカルを出し続ける実力者！！" },
    SAIC: { title: "国家転覆系男子",                     text: "普段は目立たないけれど心に秘めた野望は誰にも負けない！！いつもひそかに気をうかがい、野望のためなら何でもできる！" },
    SABO: { title: "ルービックキューブ揃え人",           text: "独自の世界観と肉体で笑いを作る異星人。一度見たら忘れられない唯一無二の存在感を放つ。" },
    SABC: { title: "スライムアメーバ",     text: "なろうと思ったらなんにでもなれる！見た技術を吸収してすぐさま自分のものにしてしまう！！" },
};
